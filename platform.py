...
def send_smtp(to_list, subject, html_body):
    ...
    msg["Subject"] = subject; msg["From"] = f"TF Research <{sender}>"; msg["To"] = ", ".join(to_list)
        ...
        if self.path == "/api/subscribe":
            ...
            try:
                ...
                for sub in subs["list"]:
                    ...
                    ok, _ = send_smtp([sub["email"]], f"TF Research Haftalik Bulten - {datetime.now().strftime('%d.%m.%Y')}", html)
                    if ok: ok_count += 1
...
if __name__ == "__main__":
    ...
    print("="*52)
    print("  TF Research - Arastirma Platformu")

...
- vergi_oncesi_kar_mn_tl: Gelir tablosundaki "Vergi Oncesi Kar/Zarar" veya "Surdurulen Faaliyetlerden Vergi Oncesi Kar" kalemi
- ebitda_mn_tl: Once raporda "FAVOK" veya "EBITDA" satirini ara. Bulamazsan su formulu uygula: Donem Kari + Vergi Gideri + Amortisman ve Itfa Giderleri. Bu kalemleri gelir tablosu ve nakit akis tablosundan bul. Hicbirini bulamazsan null don.
...
def update_company_financials(extracted):
    ...
    try:
        ...
        for field in ["donem", "toplam_varlik_mn_tl", "tf_alacaklari_mn_tl",
                      ...
                      "esas_faaliyet_gelirleri_mn_tl", "vergi_oncesi_kar_mn_tl", "ebitda_mn_tl"]:
